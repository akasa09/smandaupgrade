        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap">
                    ...
                    <div class="custom-pro-edt-ds" style="display:inline; float:right; margin-bottom:7px">
                        <form action="/admin/voters/tambah" style="display:inline">
                            <button class="btn btn-ctl-bt waves-effect waves-light m-r-10">Tambah Pemilih</button>
                        </form>
                        <button class="btn btn-ctl-bt waves-effect waves-light m-r-10" data-toggle="modal" data-target="#myModal" >Tambah Pemilih (Excel)</button>
                    </div>
                    <table>
                        <tr>
                            <th>No</th>
